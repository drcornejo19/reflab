...
const translations: Record<AppLanguage, Record<TranslationKey, string>> = {
  es: {
    ...
    "evaluations.englishExam.title": "Examen de ingles",
    "evaluations.englishExam.category": "Comunicacion",
    "evaluations.englishExam.description": "Situaciones para explicar decisiones en ingles tecnico arbitral.",
  ...
  en: {
    ...
    "evaluations.englishExam.title": "English exam",
    "evaluations.englishExam.category": "Communication",
    "evaluations.englishExam.description": "Situations to explain decisions in technical refereeing English.",
  ...
  pt: {
    ...
    "evaluations.englishExam.title": "Exame de ingles",
    "evaluations.englishExam.category": "Comunicacao",
    "evaluations.englishExam.description": "Situacoes para explicar decisoes em ingles tecnico arbitral.",
