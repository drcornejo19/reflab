...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-[#020b14] text-white flex flex-col items-center justify-center px-6">
      ...
      {/* ICONOS */}
      <div className="flex items-center justify-center gap-14 md:gap-20 relative">
        ...
        {modules.map(({ href, label, Icon }, i) => (
          <div key={i} className="flex items-center gap-14 md:gap-20">
            ...
            {/* SEPARADOR */}
            {i < modules.length - 1 && (
              <div className="w-[1px] h-14 bg-gray-700 opacity-60" />
            )}
          </div>
        ))}
